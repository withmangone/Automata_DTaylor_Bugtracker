...
namespace Automata_DTaylor_Bugtracker.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            //i am sending into the post a string such as 'DemoAdmin', etc
        ...
        public async Task<ActionResult> Register(RegisterViewModel model, HttpPostedFileBase avatar)
        {
            ...
            {             
                ...
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, FirstName = model.FirstName, LastName = model.LastName, ProfilePic = "/Avatar/Default-avatar.jpg" };
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    TempData["PasswordResetFailure"] = "true";
